...
public partial class EditTags : System.Web.UI.Page
{
    int tag = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (cmstrDefualts.CheckQueryString("tags", out tag))
        {
            ...
            BlogTypeMyForm.BackURL = "ManageTags.aspx?cat=" + Request.QueryString["cat"] + "&sub=" + Request.QueryString["sub"] + "&sitelang=" + Request.QueryString["sitelang"];
