...
{
    public class oAuthTwitter : oAuthExample.OAuthBase
    {
        ...
        private string _consumerKey =  siteDefaults.GetParam("twittercode");//  "O4pqeNQ2P4DMWu5vtoq89g";// "OPwpqGrery6T7QOMt6Cgcg";
        private string _consumerSecret = siteDefaults.GetParam("twittersecret");// "XKfNibGkLtBCzPaaT6t3uOWry3GVwXd5RN5QnpGbBOg"; // "jMq4JEEi1iemEAHo15PHGh3pPQP53EMQtXQSOJaGIc";
        private string _token = "";
        private string _tokenSecret = "";
        private string _callBackUrl = siteDefaults.GetLink("");// "http://spindate.comstar.co.il/twitter.aspx";
...
#region Properties
        ...
        public string oAuthWebRequest(Method method, string url, string postData)
        {
            ...
            //Generate Signature
            string sig = this.GenerateSignature(uri, this.ConsumerKey,this.ConsumerSecret,this.Token,this.TokenSecret,this.CallBackUrl,this.OAuthVerifier,method.ToString(), timeStamp,nonce,out outUrl, out querystring);
